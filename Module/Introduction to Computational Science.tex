...
\usepackage{xcolor}
\usepackage{xr} % For external references - allows referencing figures/tables from other documents
...
\newcommand\CourseTitle{Introduction to Computational Science}
\newcommand\CourseCode{CS 212}
...
\newcommand{\BookTitle}{Introduction to Computational Science}
...
%%%%%%%%%%%
\chapter*{Preface}
\begin{chapquote}{Stephen Wolfram}
``A new kind of science is emerging that is
fundamentally changing our view of the world.''
\end{chapquote}
...
\input{chapters/C1 - Introduction to Computational Science.tex}
